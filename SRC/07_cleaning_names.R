...
#Cleaning the names.
df_controls$District <- gsub(">", "a", df_controls$District)
df_controls$District <- gsub("@", "u", df_controls$District)
df_controls$District <- gsub("\\|", "i", df_controls$District)  
...
df_controls$District <- tolower(df_controls$District)
